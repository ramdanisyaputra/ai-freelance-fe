      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Masuk ke akun BidanAI kamu</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/forgot-password" className="text-sm text-[#FE5B00] hover:text-[#E54F00] font-medium">
                Lupa password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            Belum punya akun?{' '}
            <Link href="/register" className="text-[#FE5B00] hover:text-[#E54F00] font-semibold">
              Daftar sekarang
            </Link>
          </p>
        </div>
