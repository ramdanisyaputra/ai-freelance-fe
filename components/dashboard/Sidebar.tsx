            ...
            <aside className={`fixed inset-y-0 left-0 z-[100] w-64 bg-white border-r border-gray-100 transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full'
                ...
                <div className="p-4 border-t border-gray-100">
                    <div className="flex items-center p-2 rounded-lg bg-gray-50">
                        <div className="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center text-[#FE5B00] font-bold text-xs">
                            U
                        </div>
                        <div className="ml-3">
                            <p className="text-xs font-medium text-gray-900">Free Plan</p>
                            <p className="text-[10px] text-gray-500">Upgrade to Pro</p>
                        </div>
                    </div>
                </div>
            </aside>
